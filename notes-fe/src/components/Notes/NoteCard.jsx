            ...
            {note.codeMetadata && (
                <div className="mb-2">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-sm font-semibold text-gray-700">{note.codeMetadata.language}</span>
                        {note.codeMetadata.fileContext && (
                            <span className="text-xs text-gray-500">• {note.codeMetadata.fileContext}</span>
                        )}
                    </div>
                    {note.codeMetadata.errors?.length > 0 && (
                        <div className="mb-2 space-y-1">
                            {note.codeMetadata.errors.map((err, i) => (
