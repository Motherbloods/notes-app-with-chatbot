          ...
          {!isSkipMode && codeMetadata ? (
            <div className="space-y-4">
              ...
              {codeMetadata.suggested &&
                codeMetadata.suggested !== codeMetadata.formatted && (
              ...
              <div>
                ...
                <pre className="bg-secondary text-primary p-4 rounded-lg text-xs overflow-auto max-h-96 font-mono leading-relaxed">
            ...
            <div className="space-y-4">
              {!isSkipMode && lineFormats && lineFormats.length > 0 && (
                <div className="border border-accent/40 bg-accent/10 rounded-lg p-4">
                  ...
                  <p className="text-xs text-accent/70 mb-3">
                    {
                      lineFormats.filter((f) => f.suggestedFormat !== "keep")
                        .length
                    }{" "}
                    line(s) converted to better format
                  </p>
                    ...
                    <div className="mt-3 space-y-2">
                      {lineFormats.map((lineFormat, i) => {
                        ...
                        return (
                          <div
                            key={i}
                            className="bg-secondary rounded p-3 border border-accent/40 text-xs"
                          >
                            <div className="flex items-center gap-2 mb-1">
                              <span
                                className={`px-2 py-0.5 rounded font-medium ${
                                  lineFormat.suggestedFormat === "checklist"
                                    ? "bg-green-100 text-green-700"
                                    : lineFormat.suggestedFormat === "numbered"
                            ...
                            <div className="text-gray-500 line-through mb-1">
                              {lineFormat.originalLine}
                            </div>
                            <div className="text-primary font-medium mb-1">
                              {lineFormat.convertedLine}
                            </div>
